---
layout: single
title: "시험기간에 학교 도서관 앱 해킹하기 - 1 (네트워크 트래픽 분석)"
toc: true
toc_sticky: true
toc_label: "목차"
tags: [네트워크, 단축어, Mobile]
...
```{
  "libtechAccountSuccess": "1",  // 로그인 성공 여부
  "libtechAccountLogon": "ok",   // 로그인 결과
  "libtechAccountUserid": "202002502",  // 학번
  "libtechAccountUseridQr": "0202002502^00220250425013117", // 학번 + QR 토큰
  "libtechAccountPassword": null,  // 비밀번호는 반환하지 않음
  "libtechAccountName": "이태규",  // 이름
  ...
  "libtechAccountDepart": "소프트웨어전공",
  "libtechAccountUniv": "소프트웨어응용학부",
  "libtechAccountUserlevel": "0006",  // 등급 코드
  "libtechAccountProfileimage": "/LibtechUpload/UserPhoto/0202002502.jpg", // 사진 경로
  ...
  "libtechAccountPhoneUid": "E214C949-BA49-4E82-AC6C-39D0BBFC0628", // 기기 고유 식별자 (UUID)
  "libtechAccountPhoneType": "i", // iOS
  "libtechAccountPhoneValid": "1", // 유효성 확인 결과
  "libtechAccountPhoneDate": "20240902" // 등록된 유효 기한
}
```
