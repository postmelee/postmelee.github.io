...
![WIFI 환경 (약 11초 소요)](/2025-05-09/app_qr_wifi.gif?raw=true) | ![LTE 환경 (약 46초 소요)](/2025-05-09/app_qr_lte.gif)
--- | ---
...
![ip확인](/2025-05-09/ip.png)

내 IP는 `192.168.219.43`이다 (빽다방에서 글 작성중)

### iPhone에서 프록시 설정
![phone_proxy1](/2025-05-09/phone_proxy1.PNG) | ![phone_proxy2](/2025-05-09/phone_proxy2.PNG)
---|---
...
![mitmproxy](/2025-05-09/mitmproxy3.png)
아직 스마트폰에서 아무것도 실행하지 않아 네트워크 기록이 없다.

도서관 앱을 키고 모바일 이용증 화면을 들어가봤다.

![터미널화면](/2025-05-09/term1.png)
...
![term1_req.png](/2025-05-09/term1_req.png)
...
![term1_res.png](/2025-05-09/term1_res.png)
...
![MacOS 단축어 화면](/2025-05-09/shortcut3.PNG) | ![iOS 단축어 화면](/2025-05-09/shortcut2.PNG)
--- | ---
...
![shortcut_run.gif](/2025-05-09/shortcut_run.gif){: width="50%" height="50%"}
